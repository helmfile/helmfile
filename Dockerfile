...
RUN set -x && \
    ...
    case ${TARGETPLATFORM} in \
         "linux/amd64")  HELM_SHA256="138676351483e61d12dfade70da6c03d471bbdcac84eaadeb5e1d06fa114a24f"  ;; \
         "linux/arm64")  HELM_SHA256="d12a0e73a7dbff7d89d13e0c6eb73f5095f72d70faea30531941d320678904d2"  ;; \
    esac && \
