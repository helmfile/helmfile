...
RUN set -x && \
    ...
    "linux/amd64")  HELM_SHA256="c306b46f719b0a4da32d0f78ee21bf90ce8d602f15b22ab753f0674d1670a7f3"  ;; \
    "linux/arm64")  HELM_SHA256="564de2191b881e9f71b5606b25345821ea1682f06ab90499d3ab22b530176da1"  ;; \
    esac && \
...
RUN helm plugin install https://github.com/databus23/helm-diff --version v3.15.12 --verify=false && \
